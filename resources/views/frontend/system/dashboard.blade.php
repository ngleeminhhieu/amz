            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-12">
                    <div class="single-banner tab-height">
                        <img src="https://via.placeholder.com/600x370" alt="#">
                        <div class="content">
                            <p>KPOP's Accessories</p>
                            <h3>Flash sale <br> Up to <span>40%</span> Off</h3>
                            <a href="#">Discover Now</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="product-info">
                        <div class="nav-main">
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#fanlight"
                                        role="tab">Fanlight</a></li>
                                <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#ablum"
                                        role="tab">Ablum</a></li>
                                <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#accessories"
                                        role="tab">Accessories</a></li>
                                <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#flashsale"
                                        role="tab">Flash sale</a></li>
                            </ul>
                            <!--/ End Tab Nav -->
                        </div>
                        <div class="tab-content" id="myTabContent">
                            <!-- Start Single Tab -->
                            <div class="tab-pane fade show active" id="fanlight" role="tabpanel">
                                <div class="tab-single">
                                    <div class="row">
                                            ...
                                            <div class="single-product">
                                                <div class="product-img">
                                                    ...
                                                    <div class="button-head">
                                                        <div class="product-action">
                                                            <a data-toggle="modal" data-target="#{{$item->nameUrl}}"
                                                                title="Quick View" href="#"><i
                                                                    class=" ti-eye"></i><span>Quick Shop</span></a>
                                                            <a title="Wishlist" href=""><i
                                                                    class=" ti-heart "></i><span>Add
                                                                    to Wishlist</span></a>
                                                ...
                                                <div class="product-content">
                                                    ...
                                                    <div class="product-price">
                                                        ...
                                                        <strong>{{number_format($item->price-$item->sale)}}
                                                            VND</strong>
                                                        @else
                                        ...
                                        <div class="container-scroller modal fade" id="{{$item->nameUrl}}" tabindex="-1"
                                            role="dialog">
                                                        ...
                                                        <div class="row no-gutters">
                                                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                                                ...
                                                                <div class="product-gallery">
                                                                    <div class="quickview-slider-active">
                                                                        <div class="single-slider">
                                                                            <center style="margin: 100px;"><img
                                                                                    src="{{$item->img}}" width="300px;"
                                                                                    width="300px;" alt="#">
                                                                            </center>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                                                <div class="quickview-content">
                                                                    ...
                                                                    @if ($item->sale && $item->sale>0)
                                                                    <small><s>{{number_format($item->price)}}
                                                                            VND</s></small>
                                                                    <strong
                                                                        class="new">{{number_format($item->price-$item->sale)}}
                                                                        VND</strong>
                                                                    @else
                                                                    <strong class="new">{{number_format($item->price)}}
                                                                        VND</strong>
                                                                    @endif
                                                                    <div class="quickview-peragraph">
                                                                        <strong>{{$item->product_describe}}</strong>
                                                                        <div>{{$item->product_detail}}</div>
                                                                    </div>
                            ...
                            <!-- Start Single Tab -->
                            <div class="tab-pane fade" id="ablum" role="tabpanel">
                                <div class="tab-single">
                                    <div class="row">
                                        @foreach ($listablum as $item)
                                        <div class="col-xl-3 col-lg-4 col-md-4 col-12">
                                            <div class="single-product">
                                                <div class="product-img">
                                                    <a href="{{route('f.showproduct',[$item->id])}}">
                                                ...
                                                <div class="product-content">
                                                    ...
                                                    <div class="product-price">
                                                        @if ($item->sale && $item->sale>0)
                                                        <small><s>{{number_format($item->price)}} VND</s></small>
                                                        <strong class="new">{{number_format($item->price-$item->sale)}}
                                                            VND</strong>
                                                        @else
                                                        <strong class="new">{{number_format($item->price)}} VND</strong>
                                                        @endif
                            ...
                            <div class="tab-pane fade" id="flashsale" role="tabpanel">
                                <div class="tab-single">
                                    <div class="row">
                                            ...
                                            <div class="single-product">
                                                <div class="product-img">
                                                    ...
                                                    <div class="button-head">
                                                        <div class="product-action">
                                                            <a data-toggle="modal"
                                                                data-target="#{{$item->nameUrl}}_sale"
                                                                title="Quick View" href="#"><i
                                                                    class=" ti-eye"></i><span>Quick Shop</span></a>
                                                            <a title="Wishlist" href="#"><i
                                                                    class=" ti-heart "></i><span>Add
                                        ...
                                        <div class="container-scroller modal fade" id="{{$item->nameUrl}}_sale"
